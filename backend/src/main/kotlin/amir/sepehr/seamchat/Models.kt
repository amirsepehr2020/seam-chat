...
@Serializable data class MessageDto(val id:String,val conversationId:String,val senderId:String,val body:String?,val type:String,val createdAt:Long,val editedAt:Long?=null,val deleted:Boolean=false,val replyToMessageId:String?=null)
...
@Serializable data class ReplyMessageRequest(val body:String,val type:String="text")
